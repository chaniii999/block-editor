(() => {
  ...
  // ../../node_modules/.pnpm/@codemirror+state@6.5.4/node_modules/@codemirror/state/dist/index.js
  var Text = class {
    /**
  ...
  var BlockWrapper = class extends RangeValue {
  ...
  var BlockWrapperTile = class extends CompositeTile {
  ...
  var LineTile = class extends CompositeTile {
  ...
  var MarkTile = class extends CompositeTile {
  ...
  var TextTile = class extends Tile {
  ...
  // ../../node_modules/.pnpm/@codemirror+lint@6.9.5/node_modules/@codemirror/lint/dist/index.js
  ...
  // <stdin>
  var sysmlKeywords = /* @__PURE__ */ new Set([
    "package",
    "library",
    "namespace",
    "import",
  ...
  var sysmlBuiltinTypes = /* @__PURE__ */ new Set([
    "Boolean",
    "String",
    "Integer",
    "Real",
  ...
  var sysmlTokenizer = StreamLanguage.define({
    name: "sysml",
    startState: () => ({ inBlockComment: false, inLineComment: false }),
    token(stream, state) {
      ...
      if (stream.match(/^[A-Za-z_][A-Za-z0-9_]*/)) {
        ...
        if (sysmlKeywords.has(word))
          return "keyword";
        if (sysmlBuiltinTypes.has(word))
          return "type";
        if (/^[A-Z]/.test(word))
          return "type";
        return null;
  ...
  var sysmlLanguage = new LanguageSupport(sysmlTokenizer);
  window.CM = {
    EditorView,
    EditorState,
    basicSetup,
